...
/**
 * Created by MichaelS on 2/11/2018.
 */

public class Irishplay extends GameScreen {
    ...
    public void initialize() {
        ...
        musicSound = Gdx.audio.newMusic(Gdx.files.internal("IrishSong.mp3"));
    ...
    public void createActors() {
        ...
        background = ActorUtils.createActorFromImage("Ireland Background");
        background.setSize(stage.getViewport().getScreenWidth(), stage.getViewport().getScreenHeight());
        stage.addActor(background);

        ball1 = ActorUtils.createActorFromImage("HockeyPuckShamrock.png");
    ...
    @Override
    public void setInputForActors() { ball1.addListener(new ActorGestureListener() {
        @Override
